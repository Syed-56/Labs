...
sns.histplot(df['SalePrice'] , color = 'blue' , bins=100 , kde=True)    #kde is the freq curve and bins is number of bars
...
golden_features_list = df_num_corr[abs(df_num_corr) > 0.5].sort_values(ascending=False) #only keep strong corelaive features (corr>0.5)
